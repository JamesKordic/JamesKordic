  ...
  return (
    <article className={`min-w-0 bg-bg ${className}`}>
      ...
      >
        ...
        <div className="flex flex-1 items-start justify-between gap-3 border-t border-line px-4 py-4 sm:gap-5 sm:px-5 sm:py-6">
          <div className="min-w-0">
            <h2 className="font-display text-[clamp(24px,7vw,28px)] font-semibold uppercase leading-[0.9] tracking-[-0.045em] transition-colors group-hover:text-accent sm:text-[clamp(28px,3.2vw,48px)] sm:leading-[0.88] sm:tracking-[-0.055em]">
              {project.title}
            </h2>
          ...
          <span className="flex h-9 w-9 shrink-0 items-center justify-center border border-line text-base transition-all group-hover:-translate-y-1 group-hover:translate-x-1 group-hover:border-accent group-hover:bg-accent group-hover:text-accent-ink sm:h-10 sm:w-10 sm:text-lg">
            ↗
          </span>
        </div>
      </Link>
